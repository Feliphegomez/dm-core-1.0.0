...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 micro per kB (0.00001 DMC). This is to prepare for dropping the minimum transaction fee to 0.1 micro per kB (0.0001 DMC) in the next release.
