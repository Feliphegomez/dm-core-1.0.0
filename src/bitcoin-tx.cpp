...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s demedallocore-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  demedallocore-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded demedallocore transaction") + "\n" +
              "  demedallocore-tx [options] -create [commands]   " + _("Create hex-encoded demedallocore transaction") + "\n" +
              "\n";
