...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/demedallocore-project/demedallocore>";
    const std::string URL_WEBSITE = "<https://demedallocore.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("deMedallocore version %s\n", FormatFullVersion());
}
